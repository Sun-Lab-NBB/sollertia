...
skill exists for a new system yet, so the extension creates one inside a new companion plugin, as the acquisition-system
recipe's marketplace touch points spell out.
