...
then mirror the shape and leave the values behind.
...
- [ ] All twelve cross-repo constants moved together, verified row by row
- [ ] A new module header is listed in Doxyfile INPUT and carries a doxygenfile block in docs/source/api.rst
